<%@ Page Title="Takvim" Language="C#" MasterPageFile="~/Admin/admin.Master" Culture="tr-TR" AutoEventWireup="true" CodeBehind="takvim.aspx.cs" Inherits="GedizMakina.Admin.takvim" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <dxwschs:ASPxScheduler ID="ASPxScheduler1" runat="server" AppointmentDataSourceID="dsAjanda" ClientIDMode="AutoID" Theme="MaterialCompact" Width="100%" meta:resourcekey="ASPxScheduler1Resource1" Start="2024-09-13">
                        <Views>
                            <DayView ViewSelectorItemAdaptivePriority="2" ShortDisplayName="Günlük">
                                <TimeRulers>
                                    <cc1:TimeRuler meta:resourcekey="TimeRulerResource1"></cc1:TimeRuler>
                                </TimeRulers>
                            ...
                            <WorkWeekView ViewSelectorItemAdaptivePriority="6" ShortDisplayName="Hafta">
                                <TimeRulers>
                                    <cc1:TimeRuler meta:resourcekey="TimeRulerResource2"></cc1:TimeRuler>
                                </TimeRulers>
                            ...
                            <FullWeekView Enabled="true" ShortDisplayName="Tüm Hafta">
                                <TimeRulers>
                                    <cc1:TimeRuler meta:resourcekey="TimeRulerResource3"></cc1:TimeRuler>
                                </TimeRulers>
        ...
        <div class="col-md-3">
            <div class="row">
                <div class="col-md-12">
                    <dxwschs:ASPxDateNavigator ID="ASPxDateNavigator1" runat="server" ClientIDMode="AutoID" MasterControlID="ASPxScheduler1" Theme="MaterialCompact" Width="100%" meta:resourcekey="ASPxDateNavigator1Resource1">
                        <Properties Rows="3">
                        </Properties>
