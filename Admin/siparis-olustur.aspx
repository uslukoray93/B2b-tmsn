<%@ Page Title="Sipariş Oluştur" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="siparis-olustur.aspx.cs" Inherits="GedizMakina.Admin.siparis_olustur" %>
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:SqlDataSource ID="dsCariler" runat="server" ConnectionString="<%$ ConnectionStrings:gediz %>" SelectCommand="SELECT [CariId], [CariKodu], [CariAdi] FROM [Cariler] ORDER BY [CariAdi]"></asp:SqlDataSource>
                </div>
            </div>
            <hr />
            <div class="row">
