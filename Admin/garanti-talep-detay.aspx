<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="garanti-talep-detay.aspx.cs" Inherits="GedizMakina.Admin.garanti_talep_detay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-md-1">
            <asp:Label ID="Label14" runat="server" Text="Garanti Tipi"></asp:Label></div>
        <div class="col-md-11">
...
Order By 9 ASC">
                <SelectParameters>
                    <asp:SessionParameter Name="CariId" SessionField="sCariId" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-1">
            <asp:Label ID="Label4" runat="server" Text="Adı Soyadı"></asp:Label></div>
        <div class="col-md-5">
            <asp:TextBox ID="txtMamulSahibi" runat="server" CssClass="form-control" Width="100%"></asp:TextBox></div>
        <div class="col-md-1">
            <asp:Label ID="Label7" runat="server" Text="Telefon"></asp:Label></div>
        <div class="col-md-5">
            <asp:TextBox ID="txtMamulSahibiTelefon" runat="server" CssClass="form-control" Width="100%"></asp:TextBox></div>
    </div>
    <br />
    <div class="row" style="background-color: #444444; height: 28px; border-radius: 5px">
    ...
    <div class="row">
        <div class="col-md-1">
            <asp:Label ID="Label8" runat="server" Text="Unvanı"></asp:Label></div>
        <div class="col-md-5">
            <asp:TextBox ID="txtCariAdi" runat="server" CssClass="form-control" Width="100%" Enabled="False"></asp:TextBox></div>
        <div class="col-md-1">
            <asp:Label ID="Label9" runat="server" Text="Adres"></asp:Label></div>
        <div class="col-md-5">
            <asp:TextBox ID="txtCariAdres" runat="server" CssClass="form-control" Width="100%" Enabled="False"></asp:TextBox></div>
    </div>
    <div class="row">
        <div class="col-md-1">
            <asp:Label ID="Label15" runat="server" Text="Şehir"></asp:Label></div>
        <div class="col-md-5">
            <asp:TextBox ID="txtCariSehir" runat="server" CssClass="form-control" Width="100%" Enabled="False"></asp:TextBox></div>
        <div class="col-md-1">
            <asp:Label ID="Label16" runat="server" Text="İlçe"></asp:Label></div>
        <div class="col-md-5">
            <asp:TextBox ID="txtCariIlce" runat="server" CssClass="form-control" Width="100%" Enabled="False"></asp:TextBox></div>
    </div>
    <div class="row">
        <div class="col-md-1">
            <asp:Label ID="Label17" runat="server" Text="Telefon"></asp:Label></div>
        <div class="col-md-5">
            <asp:TextBox ID="txtCariTelefon" runat="server" CssClass="form-control" Width="100%" Enabled="False"></asp:TextBox></div>
        <div class="col-md-1">
            <asp:Label ID="Label18" runat="server" Text="E-Posta"></asp:Label></div>
        <div class="col-md-5">
            <asp:TextBox ID="txtCariEposta" runat="server" CssClass="form-control" Width="100%" Enabled="False"></asp:TextBox></div>
    </div>
    <hr />
    <div class="row">
        <div class="col-md-4">
