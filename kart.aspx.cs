...
namespace GedizMakina
{
    public partial class kart : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string merchant_id = dr["MerchantId"].ToString();
            string merchant_key = dr["MerchantKey"].ToString();
            string merchant_salt = dr["MerchantSalt"].ToString();
            //

            DataRow drCari = cn.DataRowGetir("Select * From Cariler Where CariId = " + Session["sLoginId"].ToString() + "");
            // Müşterinizin sitenizde kayıtlı veya form vasıtasıyla aldığınız eposta adresi
            string emailstr = drCari["Eposta"].ToString();
            //
            // Tahsil edilecek tutar. 9.99 için 9.99 * 100 = 999 gönderilmelidir.
            int payment_amountstr = Convert.ToInt32(Session["sOdenecekTutarKK2"].ToString());
            //
            // Sipariş numarası: Her işlemde benzersiz olmalıdır!! Bu bilgi bildirim sayfanıza yapılacak bildirimde geri gönderilir.
            string merchant_oid = CreateOidCode(10);

            Session["sMerchantOid"] = merchant_oid;
            //
            // Müşterinizin sitenizde kayıtlı veya form aracılığıyla aldığınız ad ve soyad bilgisi
            string user_namestr = drCari["Yetkili"].ToString();
            //
            // Müşterinizin sitenizde kayıtlı veya form aracılığıyla aldığınız adres bilgisi
            string user_addressstr = drCari["Adres1"].ToString();
            //
            ...
            string merchant_ok_url = "https://korayuslu.com/siparisiniz-olusturuluyor";
            //
            // Ödeme sürecinde beklenmedik bir hata oluşması durumunda müşterinizin yönlendirileceği sayfa
            // !!! Bu sayfa siparişi iptal edeceğiniz sayfa değildir! Yalnızca müşterinizi bilgilendireceğiniz sayfadır!
            // !!! Siparişi iptal edeceğiniz sayfa "Bildirim URL" sayfasıdır (Bakınız: 2.ADIM Klasörü).
            string merchant_fail_url = "https://korayuslu.com/decline";
            //        
        ...
        private string CreateOidCode(int size)
        {
