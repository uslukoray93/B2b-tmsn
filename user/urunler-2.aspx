<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="urunler-2.aspx.cs" Inherits="GedizMakina.user.urunler_2" %>
...
Order By SiraNo">
            ...
            <div class="col-lg-3-5 col-xl-4-5">
                <div class="row row-gutter-sm">
                    ...
                    <asp:SqlDataSource ID="dsUrunGetir" runat="server" ConnectionString="<%$ ConnectionStrings:gediz %>" SelectCommand="spUrunListesiKategori" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="dsUrunGetir2" runat="server" ConnectionString="<%$ ConnectionStrings:gediz %>" SelectCommand="spUrunListesiKategori" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:SessionParameter Name="KategoriId" SessionField="sYeniKategoriId" Type="Int32" />
                            <asp:SessionParameter Name="First" SessionField="sFirst" Type="Int32" />
                            <asp:SessionParameter Name="Last" SessionField="sLast" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
