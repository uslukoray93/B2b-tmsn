...
{
    public partial class odeme_test : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //DataRow drOdenecek = cn.DataRowGetir("Select convert(int, ROUND('" + Session["sOdenecekTutarKK"] + "', 2) * 100) Odenecek");
            ...
            //SqlCommand cm = new SqlCommand("spSepetGetirSecili", cn._Baglan());
            //cm.CommandType = CommandType.StoredProcedure;
            //cm.Parameters.AddWithValue("@CariId", Session["sLoginId"].ToString());
            //cm.Parameters.AddWithValue("@OdemeSekli", Session["sOdemeTipi"].ToString());
