...
{
    public partial class kknew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //lblOdemeTutari.Text = "Kartınızdan toplam " + Session["sOdenecekTutarKK"].ToString() + " TL tutarında çekim yapılacaktır";
            }
        }
        ...
        protected void btnGonder_Click(object sender, EventArgs e)
        {
            ...
            //string merchant_ok_url = "https://crmtest.saglamkredi.com.tr";
            ////
            //// Ödeme sürecinde beklenmedik bir hata oluşması durumunda müşterinizin yönlendirileceği sayfa
            //// !!! Bu sayfa siparişi iptal edeceğiniz sayfa değildir! Yalnızca müşterinizi bilgilendireceğiniz sayfadır!
            //// !!! Siparişi iptal edeceğiniz sayfa "Bildirim URL" sayfasıdır (Bakınız: 2.ADIM Klasörü).
            //string merchant_fail_url = "https://basvuru.saglamkredi.com.tr";
            ////        
        ...
        //{
        //    lblUyari.Text = "Ödemeniz onaylanmadı";
        //}
    }
}