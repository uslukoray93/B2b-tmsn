<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="GedizMakina.user.login" %>
...
<head>
    ...
    <title>Gediz Makina | B2B</title>
</head>
<body>


    <div class="d-lg-flex half">
        <div class="bg order-1 order-md-2" style="background-image: url('/login-form-02/images/yapi.jpg');"></div>
                    ...
                    <div class="col-md-7">
                        ...
                        <form id="form1" runat="server">
                            <div class="form-group first">
                                <label for="username">Cari Kodu</label>
                                <input type="text" class="form-control" placeholder="Cari Kodunuzu Girin" id="txtCariKodu" runat="server">
                            </div>
