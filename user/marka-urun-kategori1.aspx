<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="marka-urun-kategori1.aspx.cs" Inherits="GedizMakina.user.marka_urun_kategori1" %>
            ...
            <div class="col-lg-2-5 col-xl-1-5 mb-4 mb-lg-0">
                <div class="filters-sidebar-wrapper bg-light rounded">
                    <div class="card card-modern">
                        ...
                        <div class="card-body">
                            <asp:DropDownList ID="ddKategori" runat="server" CssClass="form-control" AutoPostBack="True" DataSourceID="dsAnaKategori" DataTextField="KategoriAdi" DataValueField="KategoriId" OnSelectedIndexChanged="ddKategori_SelectedIndexChanged"></asp:DropDownList>
                            <asp:SqlDataSource ID="dsAnaKategori" runat="server" ConnectionString="<%$ ConnectionStrings:gediz %>" SelectCommand="Select * From Kategoriler Where UstKategoriId = @UstKategoriId
UNION
Select * From Kategoriler Where KategoriId = 1000000075
Order By SiraNo">
                                <SelectParameters>
                                    <asp:SessionParameter Name="UstKategoriId" SessionField="sKategoriId" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </div>
                    </div>
                    ...
                    <div class="card card-modern">
                        ...
                        <div class="card-body">
                            <asp:DropDownList ID="ddMarka" runat="server" CssClass="form-control" AutoPostBack="True" DataSourceID="dsMarkalar" DataTextField="MarkaAdi" DataValueField="MarkaId" OnSelectedIndexChanged="ddMarka_SelectedIndexChanged"></asp:DropDownList>
                            <asp:SqlDataSource ID="dsMarkalar" runat="server" ConnectionString="<%$ ConnectionStrings:gediz %>" SelectCommand="SELECT [MarkaAdi], [MarkaPath], [MarkaId] FROM [Markalar] ORDER BY [SN]"></asp:SqlDataSource>
            ...
            <div class="col-lg-3-5 col-xl-4-5">
                <div class="row row-gutter-sm">
                    ...
                    <asp:SqlDataSource ID="dsUrunGetir" runat="server" ConnectionString="<%$ ConnectionStrings:gediz %>" SelectCommand="spMarkaKategoriUrunListesi" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            ...
                            <asp:QueryStringParameter Name="MarkaId" QueryStringField="marka" Type="Int32" />
                            <asp:QueryStringParameter Name="KategoriId" QueryStringField="kategori" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
