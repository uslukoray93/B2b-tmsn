<%@ Page Title="Cari Listesi" Language="C#" MasterPageFile="~/Mt/mt.Master" AutoEventWireup="true" CodeBehind="cari-listesi.aspx.cs" Inherits="GedizMakina.Mt.cari_listesi" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                ...
                <asp:SqlDataSource ID="dsCariListesi" runat="server" ConnectionString="<%$ ConnectionStrings:gediz %>" SelectCommand="spMtCariListesi" SelectCommandType="StoredProcedure">
                    <SelectParameters>
